...
export default class NtReport {
  ...
  [_createDatagrid](grid_element) {
    ...
    let header_options = {
      "font-size": grid_options["font-size"], color: grid_options.color, "border-color": grid_options["border-color"],
    ...
    if (header_options.grid_width.indexOf("%") > -1) {
      ...
      header_options.grid_width = parseFloat(header_options.grid_width);
    ...
    switch (etype) {
      ...
      case "html":
        ...
        this.doc.fromHTML(html, this.template.page.cursor.x, this.template.page.cursor.y,
          ...
          }, (dispose) => this[_setHtmlCursor](dispose),
          {
